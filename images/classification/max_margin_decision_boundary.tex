...
\node[draw, circle, minimum width =0.2 cm, thick, color=green, fill=blue] (x7) at (3, -1.5) {};
\node[draw, circle, minimum width =0.2 cm, color=red, fill=red] (x8) at (4.5, 1.75) {};
\node[draw, circle, minimum width =0.2 cm, thick, color=green, fill=red] (x9) at (3, 0.5) {};
\node[draw, circle, minimum width =0.2 cm, color=red, fill=red, label=above:{}] (x10) at (5.6, 0.85) {};
\node[draw, circle, minimum width =0.2 cm, thick, color=green, fill=red] (x11) at (4.05, -0.8) {};
...
\draw[solid] (0.8,2.2) -- (4.6,-2.45);
\node[rotate=-51] (x15) at (1.5,1.0) {$ h_{SVM}({\bf x}) = +1 $};
\node[rotate=-51] (x16) at (1.85,1.25) {$ h_{SVM}({\bf x}) = -1 $};
\draw[dashed] (1.3,2.3) -- (5.1,-2.35);
\node[] (x15) at (0.4, 1.4) {};
\node[] (x16) at (3.2, 1.4) {};
\draw[dashed] (0.35,2) -- (4.05,-2.5);
\node[] (x17) at (0.4, 1.4) {};
\node[] (x18) at (3.2, 1.4) {};
\end{tikzpicture}
\end{document}