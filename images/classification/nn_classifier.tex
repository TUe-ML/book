...
\node[draw, circle, minimum width =1.75 cm, color=black, dashed, fill=white] (x4) at (5, 0) {};
...
\node[draw, circle, minimum width =0.2 cm, color=blue, fill=blue, label=above:{$ \left( {\bf x}_{c}, y_{c} \right) $}] (x10) at (5.6, 0.85) {};
