...
\node[draw, circle, minimum width =0.2 cm, thick, color=blue, fill=red] (x3) at (2, -1) {};
\node[draw, circle, minimum width =0.2 cm, thick, color=yellow, fill=blue] (x5) at (3.4, 0) {};
...
\draw[dashed] (0.8,2.2) -- (4.6,-2.45);
%\node[rotate=-51] (x15) at (1.5,1.0) {$ h({\bf x}; {\bf w}, b) = +1 $};
%\node[rotate=-51] (x16) at (1.85,1.25) {$h({\bf x}; {\bf w}, b) = -1 $};
